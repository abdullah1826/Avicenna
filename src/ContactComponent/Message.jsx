                            ...
                            <form onSubmit={handleSubmit}>
                                <div  className="myclass" >
                                    <input
                                        type='text'
                                        placeholder='Name'
                                        style={{ flex: 1, marginRight: '10px', padding: '20px', borderRadius: '16px',border:"2px solid grey" ,background:"rgb(47, 49, 53,0.5)",color:"white",outline:'none'}}
                                        value={name}
                                    ...
                                    <input
                                        type='email'
                                        placeholder='Email'
                                        style={{ flex: 1, padding: '20px', borderRadius: '5px', borderRadius: '16px',border:"2px solid grey" ,background:"rgb(47, 49, 53,0.5)",color:"white",outline:'none'}}
                                        value={email}
                                ...
                                <input
                                    type='text'
                                    placeholder='Subject'
                                    style={{ width: '100%', padding: '20px', borderRadius: '5px', marginBottom: '15px'   , borderRadius: '16px',border:"2px solid grey" ,background:"rgb(47, 49, 53,0.5)",color:"white",outline:'none'}}
                                    value={subject}
                                ...
                                <textarea
                                    placeholder='Message'
                                    style={{ width: '100%', padding: '10px', borderRadius: '5px', height: '300px', borderRadius: '16px',border:"2px solid grey" 
