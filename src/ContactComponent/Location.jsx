  ...
  return (
    <div className="ServicesContainer my-s">
      ...
      <p
        data-aos="zoom-out"
        className="paragraph"
        style={{ width: "70%", fontWeight: 100, color: "white" }}
      >
        ...
        mobile application development services, Folio3 can create the right app
        that will meet all your business and industry needs.
      </p>
      ...
      <div className="LocationMain">
        <div className="leftdiv">
          <div className="icon-data">
            ...
            >
              <MdLocationOn
                style={{ color: "rgb(58, 242, 181)", fontSize: "30px" }}
              />
            </div>
            <div style={{ width: "76%" }}>
              <h5 style={{ fontWeight: 900, fontSize: "25px", color: "white" }}>
                Location
              </h5>
              <p
                style={{
