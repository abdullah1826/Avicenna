...
function About() {
  ...
  const { image, description, writer, created_at, title } =
    location.state || {};
  ...
  return (
    ...
    >
      <div className="About">
        ...
        >
          <h5>{title}</h5>
          <h2 style={{ color: "rgb(58, 237, 178)", fontWeight: 700 }}>
            Writer
          </h2>
          <h5>{writer}</h5>
      ...
      <div
        style={{ paddingTop: "40px", width: "76%", margin: "0px auto" }}
        className="Disclaimer"
      >
        <h2 className="abouthead" style={{ color: "rgb(58, 242, 181)" }}>
          Description
        </h2>
        <p
          style={{
