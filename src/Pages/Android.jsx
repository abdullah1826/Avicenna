...
const HeroData = {
  ...
  description: '<p style="color: white; font-size: 24px; font-weight: 100;">Avicenna Enterprises Solutions is Your <span style="color: rgb(146, 199, 85);">one-step solution for <br /></span> all your development needs</p>',
